...
- [2. Image Domain](#2-image-domain)
  ...
  - [2.2 Watermarks to Guide Other Objectives](#22-watermarks-to-guide-other-objectives)
...
| [EditGuard: Versatile Image Watermarking for Tamper Localization and Copyright Protection](https://openaccess.thecvf.com/content/CVPR2024/papers/Zhang_EditGuard_Versatile_Image_Watermarking_for_Tamper_Localization_and_Copyright_Protection_CVPR_2024_paper.pdf) | CVPR                                 | 2024                      | [Github](https://github.com/xuanyuzhang21/EditGuard)               | [Arxiv](https://arxiv.org/abs/2312.08883)                | - Post-hoc watermarking with tamper localization                                                                                                                                                                                                                                                                                          |
...
| Paper                                                                                                                                                        | Proceedings / Journal | Venue Year / Last Updated | Code                                                 | Alternative PDF Source                    | Notes                                                                                                                                                                                                                                                                       |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|---------------------------|------------------------------------------------------|-------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [StegaStamp: Invisible Hyperlinks in Physical Photographs](https://ieeexplore.ieee.org/document/9156548)                                                     | CVPR                  | 2020                      | [Github](https://github.com/tancik/StegaStamp)       | [Arxiv](https://arxiv.org/abs/1904.05343) | - Watermark in physical images that can be captured from video stream<br/>- "Towards the Vulnerability of Watermarking Artificial Intelligence Generated Content" speculates that [Deepmind SynthID](https://deepmind.google/technologies/synthid/) works similarly to this |
| [ChartStamp: Robust Chart Embedding for Real-World Applications](https://dl.acm.org/doi/pdf/10.1145/3503161.3548286)                                         | ACM MM                | 2022                      | [Github](https://github.com/CGCL-codes/ChartStamp)   | -                                         | - Like StegaStamp, but it introduces less clutter in flat regions in images                                                                                                                                                                                                 |
| [Unadversarial Examples: Designing Objects for Robust Vision](https://proceedings.neurips.cc/paper/2021/hash/816a6db41f0e44644bc65808b6db5ca4-Abstract.html) | NeurIPS               | 2021                      | [Github](https://github.com/microsoft/unadversarial) | [Arxiv](https://arxiv.org/abs/2012.12235) | - Perturbations to make detection easier                                                                                                                                                                                                                                    |

## 2.3 Misc Papers (to be categorized...)
| Paper                                                                                                                                                                                                                | Proceedings / Journal                | Venue Year / Last Updated | Code                                                            | Alternative PDF Source                      | Notes                                                                                                                                                                                                                                                          |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|---------------------------|-----------------------------------------------------------------|---------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [ProMark: Proactive Diffusion Watermarking for Causal Attribution](https://openaccess.thecvf.com/content/CVPR2024/papers/Asnani_ProMark_Proactive_Diffusion_Watermarking_for_Causal_Attribution_CVPR_2024_paper.pdf) | CVPR                                 | 2024                      | -                                                               | [Arxiv](https://arxiv.org/abs/2403.09914)   | - TODO                                                                                                                                                                                                                                                         |
| [Watermarking Images in Self-Supervised Latent Spaces](https://ieeexplore.ieee.org/document/9746058)                                                                                                                 | ICASSP                               | 2022                      | [Github](https://github.com/facebookresearch/ssl_watermarking)  | [Arxiv](https://arxiv.org/abs/2112.09581)   | - TODO                                                                                                                                                                                                                                                         |
| [Generative Autoencoders as Watermark Attackers: Analyses of Vulnerabilities and Threats](https://openreview.net/forum?id=9xbArVQhnQ#all)                                                                            | ICML Workshop DeployableGenerativeAI | 2023                      | -                                                               | -                                           | - Attack on pixel-watermarks using LDM autoencoders                                                                                                                                                                                                            |
| Invisible Image Watermarks Are Provably Removable Using Generative AI                                                                                                                                                | -                                    | 2023                      | [Github](https://github.com/XuandongZhao/WatermarkAttacker.git) | [Arxiv](https://arxiv.org/abs/2306.01953)   | - Is not about rooting a model, but removing watermarks with diffusion purification<br>- Evaluates stable signature and Tree-Ring Watermarks. Tree-ring is robust against their attack.<br>- Earlier Version of Generative Autoencoders as Watermark Attackers |
...
| [Flow-Based Robust Watermarking with Invertible Noise Layer for Black-Box Distortions](https://ojs.aaai.org/index.php/AAAI/article/view/25633)                                                                       | AIII                                 | 2023                      | [Github](https://github.com/QQiuyp/FIN/)                        | -                                           | - Like HiDDeN, just a neural watermark encoder/extractor                                                                                                                                                                                                       |
...
| [AudioQR: Deep Neural Audio Watermarks For QR Code](https://www.ijcai.org/proceedings/2023/687)                                                                                             | IJCAI                 | 2023                      | [Github](https://github.com/xinghua-qu/AudioQR)                              | -                                                                              | - Imperceptible QR-codes in audio for the visually impaired                                                                                           |
...
| [Towards Codable Watermarking for Injecting Multi-Bits Information to LLMs](https://openreview.net/forum?id=JYu5Flqm9D)                | ICLR                  | 2024                      | [Github](https://github.com/lancopku/codable-watermarking-for-llm) | [Arxiv](https://arxiv.org/abs/2307.15992) | - TODO                                        |
...
- [Stable Diffusion XL](https://huggingface.co/docs/diffusers/en/using-diffusers/sdxl#stable-diffusion-xl) recommends using [invisible watermarks](https://pypi.org/project/invisible-watermark/) pip package. The [supported algorithms](https://pypi.org/project/invisible-watermark/) are [Dwt](https://en.wikipedia.org/wiki/Discrete_wavelet_transform), [Dct](https://en.wikipedia.org/wiki/Discrete_cosine_transform), and [RivaGAN](https://github.com/DAI-Lab/RivaGAN) .
- [China bans GenAI without Watermarks](https://arstechnica.com/information-technology/2022/12/china-bans-ai-generated-media-without-watermarks/)
