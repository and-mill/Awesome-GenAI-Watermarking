...
| Paper                                                            | Proceedings/Journal | Venue Year / Last Updated | Code                                                                     | Alternative PDF Source                     | Notes |
|------------------------------------------------------------------|---------------------|---------------------------|--------------------------------------------------------------------------|--------------------------------------------|-------|
| Proactive Detection of Voice Cloning with Localized Watermarking | -                   | 2024                      | [code](https://github.com/facebookresearch/audioseal?tab=readme-ov-file) | [Arxiv](https://arxiv.org/abs/2401.17264)  | -     |
