...
- [2. Image Domain](#2-image-domain)
  ...
  - [2.3 Watermarks to Guide Other Objectives](#23-watermarks-to-guide-other-objectives)
  - [2.4. Misc Papers (to Be Categorized)](#23-misc-papers-to-be-categorized)
...
| Gaussian Shading: Provable Performance-Lossless Image Watermarking for Diffusion Models                                                                                                                       | -                     | 2024                      | [Github](https://github.com/lthero-big/A-watermark-for-Diffusion-Models) | [Arxiv](https://arxiv.org/abs/2404.04956) | - Has nice overview of different types of watermarking (Post-Hox, Finetuning, Latent Imprinting)<br/>- Contains motivation example about some important fake news incident |
| [Denoising Diffusion Implicit Models](https://openreview.net/forum?id=St1giarCHLP)                                                                                                                            | ICLR                  | 2021                      | [Github](https://github.com/ermongroup/ddim)                             | [Arxiv](https://arxiv.org/abs/2010.02502) | - DDIM scheduler used in tree-ring-like papers                                                                                                                             |
| Robust Image Watermarking using Stable Diffusion                                                                                                                                                              | -                     | 2024                      | -                                                                        | [Arxiv](https://arxiv.org/abs/2401.04247) | - Very similar to Tree-Ring                                                                                                                                                |
Discussion with hints on DDIM inversion: https://github.com/ChenyangQiQi/FateZero/issues/5

## 2.3 Watermarks to Guide Other Objectives
| Paper                                                                                                                                                        | Proceedings / Journal | Venue Year / Last Updated | Code                                                 | Alternative PDF Source                    | Notes                                                                                                                                                                                                                                                                       |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|---------------------------|------------------------------------------------------|-------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
